...
<script src="${ctx}/resources/js/search/errorHistory.js"></script>
<div class="container-fluid p-2" style="height:calc(100% - 5vh) !important;">
	<div class="d-sm-flex align-items-center justify-content-between mb-1">
		<h4 class="ml-2 mb-0 text-gray-800 font-weight-bold">조회 - 오류 이력</h4>
	</div>
				...
				<div class="col-md-3">
					<div class="input-group">
						...
						<select class="custom-select mr-1 text-normal" id="selectDate">
							<option value="logRegDate">로그등록일자</option>
	...
	<div class="card table-card">
		<div class="card-body">
			...
			<table width="80%" class="table table-striped table-bordered table-hover text-normal" id="errorHistoryTable">
				<thead>
