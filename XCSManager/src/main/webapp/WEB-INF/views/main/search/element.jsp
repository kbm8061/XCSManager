...
<script src="${ctx}/resources/js/search/element.js"></script>
<div class="container-fluid p-2" style="height:calc(100% - 5vh) !important;">
	<div class="d-sm-flex align-items-center justify-content-between mb-1">
		<h4 class="ml-2 mb-0 text-gray-800 font-weight-bold">조회 - 전체 대상</h4>
		<div class="col-md-3">
			<div class="input-group">
				<h4 class="small font-weight-bold" style="margin-top:10px;">검색 구분</h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<select class="custom-select mr-1 text-normal" id="selectSearch">
					<option value = "workSearch">검색조건으로 조회</option>
					<option value = "keySearch">키값으로 조회</option>
				</select>
			</div>
		</div>
	</div>
	<div class="card mb-1 table-card" id="workValueSearch">
		<div class="card-body">
			<div class="row">
				<div class="col-md-2">
					<div class="input-group">
				...
				<div class="col-md-6">
					<div class="input-group" id='divDate'>
						...
						<button class="btn btn-primary text-normal" type="button" id="search" style="margin-left:10px;">
	...
	<div class="card mb-1 table-card" style="display:none;" id="keyValueSearch">
		<div class="card-body">
			<div class="row">
				<div class="col-md-12">
					<div class="input-group">
						...
						<select class="custom-select mr-1 text-normal" id="selectId">
							...
							<option value="elementId">앨리먼트 아이디</option>
						...
						<form class="d-none d-sm-inline-block form-inline mw-50 navbar-search w-50 text-normal" onSubmit="return false;">
							<div class="input-group">
								...
								<div class="input-group-append">
									<button class="btn btn-primary text-normal" type="button" id="keySearch">
										<i class="fas fa-search fa-sm"></i>
									</button>
								</div>
							</div>
	...
	<div class="card table-card">
		<div class="card-body">
			...
			<div class="pagination-wrapper d-flex align-items-center">
				<ul class="pagination text-normal" style="margin-bottom: 0px !important; margin-right:5px;"></ul>
				...
				<div class="button-wrapper" style="margin-left:auto;">
					<button id="downloadExcel" class="btn btn-primary text-normal"  type="button" style="min-width:140px;">
