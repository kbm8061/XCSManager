...
<script src="${ctx}/resources/js/upload/csv.js"></script>
<div class="container-fluid p-2" style="height:calc(100% - 5vh) !important;">
	<div class="d-sm-flex align-items-center justify-content-between mb-1">
		<h4 class="ml-2 mb-0 text-gray-800 font-weight-bold">등록 - CSV 등록</h4>
	</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="input-group">
						...
						<form id="frm-upload" enctype="multipart/form-data" action="/XCSManager/uploadCSV" method="post">
							<div class="input-group">
