...
<script src="${ctx}/resources/js/function/realtimeProcess.js"></script>
		...
		<div class="card-body">
			...
			<div class="pagination-wrapper d-flex align-items-center">
				...
				<div class="button-wrapper d-flex align-items-center" style="margin-left:auto;">
					<button id="downloadFile" class="btn btn-primary text-normal" type="button" style="display:none; margin-left:10px;">
						<i class="fas fa-download fa-sm"> 다운로드</i>
					</button>
					<button id="setRealtime" class="btn btn-primary text-normal" type="button" style="display:none; margin-left:10px;">
						<i class="fas fa-trash fa-sm"> 즉시 <span class="selectClassName"></span></i>
					</button>
					<button id="setStandBy" class="btn btn-primary text-normal" type="button" style="display:none; margin-left:10px;">
						<i class="fas fa-redo fa-sm"> 오류 건 대기상태 전환</i>
					</button>
				</div>
			</div>
		</div>
